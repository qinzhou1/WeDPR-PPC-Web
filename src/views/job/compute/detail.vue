          ...
          <el-col :span="24">
            <el-form label-position="right" label-width="120px" class="form">
              ...
              <el-form-item
                ...
                size="medium"
              >
                <span>{{ jobDetail.jobResultReceiverList[0] }}</span>
              </el-form-item>
...
import { queryJobDetail, queryJobAudit, queryJobLog, queryJobProgress, queryWorkflow, killJob, deleteJob } from '@/api/job'
