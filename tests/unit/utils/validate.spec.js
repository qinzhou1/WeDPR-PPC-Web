...
describe('Utils:validate', () => {
  ...
  it('validURL', () => {
    expect(validURL('https://github.com/WeBankBlockchain/WeDPR-Lab.git')).toBe(true)
    expect(validURL('http://github.com/WeBankBlockchain/WeDPR-Lab.git')).toBe(true)
    expect(validURL('github.com/WeBankBlockchain/WeDPR-Lab.git')).toBe(false)
  })
  it('validLowerCase', () => {
